...
namespace TechMastery.Messaging
{
    public class BusControlConfigurator
    {
        ...
        {
            var region = _messagingSystemsOptions.SqsOptions.Region;
            var accessKey = _messagingSystemsOptions.SqsOptions.AccessKey;
            var secretKey = _messagingSystemsOptions.SqsOptions.SecretKey;
